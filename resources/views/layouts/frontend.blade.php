                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    <div class="flag">
                                        <img src="/frontend/assets/img/icon/header_icon.png" alt="">
                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                    <a href="{{route('frontend.index')}}"><img src="/frontend/assets/img/logo/logo.png"
                                            alt=""></a>
                                </div>
                            </div>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li class="hot"><a href="#">產品</a>
                                                <ul class="submenu">
                                                    ...
                                                    <li><a
                                                            href="{{route('frontend.product.index',[$sort->id])}}">{{$sort->title}}</a>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            </li>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="/frontend/assets/img/logo/logo2_footer.png"
                                            alt=""></a>
                                </div>
