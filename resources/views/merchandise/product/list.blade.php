...
@component('layouts.component.table.th-boolean',['trueText'=>'是','falseText'=>'不是'])熱門@endcomponent
...
<tr>
    ...
    <td>
        ...
        id="status{{$item->id}}" route="{{route('merchandise.product.check.update')}}"
        {{($item['status'])?'checked':''}}>
